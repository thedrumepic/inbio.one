...
import { X, User, Link2, LayoutGrid, ArrowUpDown, Eye, Moon, Sun, BadgeCheck, ShieldCheck, Heart, ShoppingBag, Calendar, Timer, QrCode } from 'lucide-react';
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row flex-1 overflow-hidden">
                    {/* Sidebar / Top Tabs */}
                    <div className="w-full sm:w-1/3 border-b sm:border-b-0 sm:border-r border-border bg-secondary/20 p-2 sm:p-4 flex sm:flex-col gap-1 sm:gap-2 overflow-x-auto sm:overflow-y-auto no-scrollbar scroll-smooth shrink-0">
                        {tabs.map((tab) => {
                            const Icon = tab.icon;
                            return (
                                <button
